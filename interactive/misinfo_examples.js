function drawChart() {
      ...
      data.addColumn('string', 'Website Type (if known)');
      data.addColumn('number', 'Detection Score');
      data.addColumn('string', 'Tweet shared on Twitter');
      data.addRows([
      ...
      var chart = new google.visualization.Table(document.getElementById('misinfo_score_table'));
